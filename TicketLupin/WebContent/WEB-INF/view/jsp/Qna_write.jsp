...
<html>
	<head>
		<title>문의 글 작성</title>
		<link rel="stylesheet" href="<%=request.getContextPath() %>/css/Qna_write.css">
				...
				<div class="inquiry">
					...
					<table class="inquiry_table" style="border:1px solid; border-collapse:collapse;">
						...
						<tr>
							<td colspan="4">
								<center>
									<textarea class="content" style="width:99.7%; height:500px; border:0px; font-size:15px; resize:none; overflow-x:hidden;" placeholder="내용을 입력해주세요."></textarea>
								</center>
							</td>
						</tr>
					</table>

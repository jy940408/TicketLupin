...
<html>
	<head>
		<title>티켓루팡</title>
		<link rel="stylesheet" href="../css/Notice_write_admin.css">
				...
				$(document).ready(function(){
					...
					if(document.frm.ntitle.value == ""){
						...
						if(conf == true){
							...
							document.frm.action ="../Customer/NoticeModifyAction.do";
					...
					<table class="notice_table" style="border:1px solid; border-collapse:collapse;">
						...
						<tr>
							...
							<td colspan="2" style="border:1px solid;">
								<input type="text" value="${nv.ntitle}" name="ntitle" class="title" maxlength="100" style="border:0px; font-size:16.1px; width:99%" autocomplete="off">
							</td>
						...
						<tr>
							<td colspan="5">
								<center>
									<textarea type="text" name="ncontent" class="content" style="width:99%; height:500px; border:0px; font-size:15px; resize:none; overflow-x:hidden;" placeholder="내용을 입력해주세요.">${nv.ncontent}</textarea>
								</center>
							</td>
						</tr>
					</table>
					<div class="reg">
						<button type="button" class="reg_btn" onclick="modifyNotice(); return false;">등록</button>
					</div>
					</form>
					<div class="list">
						<button class="list_btn" onclick="location.href='../Customer/NoticeList.do'">
							목록으로
						</button>
					</div>
				</div>

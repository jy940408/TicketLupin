	...
	<head>
		...
		<script type="text/javascript">
			...
			function submitShow(){
				...
				document.frm.action = "<%=request.getContextPath()%>/Show/ShowModifyStep1Action.do";
						...
						<table class="open_notice_table" style="border:1px solid; border-collapse:collapse;">
							...
							<tr>
								...
								<td colspan="8" style="border:1px solid;">
									<input type="text" class="title" name="title" id="title" maxlength="100" style="width:99%; border:0px; font-size:16px;" value="${list.stitle}">
								</td>
								<th style="border:1px solid;">
									장르
								</th>
								<td colspan="1" style="border:1px solid;">
									<center>
										<select class="genre" name="genre" style="border:0px; font-size:15px; text-align-last:center;" value="${list.sgenre }">
											<option>
												오리지널/내한공연
											</option>
											<option>
								...
								<td colspan="1" style="border:1px solid;">
									<center>
									<select class="rating" name="rating" style="border:0px; font-size:15px; text-align-last:center;" value="${list.srating}">
										<option>
											전체관람가
										</option>
										<option>
							...
							<tr>
								...
								<td colspan="10" style="border:1px solid;">
									<center>
										<input type="date" class="date" name="startdate" value="${list.sopendate}">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="date" class="date" name="enddate" value="${list.senddate }">
									</center>
								</td>
								...
								<td colspan="1" style="border:1px solid;">
									<center>
										<input type="datetime-local" class="date" name="ticketingdate" value="${list.sticketingdate }">
									</center>
								</td>
							</tr>
							<tr>
								...
								<td colspan="12" style="border:1px solid;">
									<div class="map">
										<input type="text" id="sample4_postcode" name="postcode" placeholder="우편번호" style="width:70px;" value="${list.spostcode }">
										<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기">
										<input type="text" id="sample4_roadAddress" name="roadAddress" placeholder="도로명주소" value="${list.sroadaddress}">
										<input type="text" id="sample4_jibunAddress" name="jibunAddress" placeholder="지번주소" value="${list.sjibunaddress}">
										<span id="guide" style="color:#999;display:none"></span>
										<input type="text" id="sample4_detailAddress" name="detailAddress" placeholder="상세주소" value="${list.sdetailaddress}">
										<input type="text" id="sample4_extraAddress" name="extraAddress" placeholder="참고항목" value="${list.sextraaddress}">
							...
							<tr>
								...
								<td colspan="2" style="border:1px solid;"><input type="nunber" name="vipPrice" id="vipPrice" value="${list.svipprice }"></td>
								<td colspan="2" style="border:1px solid;">R</td>
								<td colspan="2" style="border:1px solid;"><input type="nunber" name="rPrice" id="rPrice" value="${list.srprice }"></td>
								<td colspan="2" style="border:1px solid;">S</td>
								<td colspan="2" style="border:1px solid;"><input type="nunber" name="sPrice" id="sPrice" value="${list.ssprice }"></td>
								<td colspan="1" style="border:1px solid;">A</td>
								<td colspan="1" style="border:1px solid;"><input type="nunber" name="aPrice" id="aPrice" value="${list.saprice }"></td>
							</tr>
						</table>
						<input type="hidden" name="sidx" value="${list.sidx}">
						<div class="reg">

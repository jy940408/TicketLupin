...
<html>
	<head>
		<title>이용안내 상세</title>
		<script src="<%=request.getContextPath() %>/js/Buyguide.js"></script>
		<link rel="stylesheet" href="<%=request.getContextPath() %>/css/Buyguide.css">
	</head>
	<body>
		<header>
			<div id="h_title">

...
<html>
	<head>
		<title>문의 관리</title>
		<script src="<%=request.getContextPath() %>/js/Myask_view_manage_write.js"></script>
		<link rel="stylesheet" href="<%=request.getContextPath() %>/css/Myask_view_manage_write.css">
	</head>
	<body>
		<header>
			<div id="h_title">
					...
					<div class="notice_info">
						...
						<table class="notice_table1">
							...
							<tr class="notice_table1_view2">
								<td colspan="4" style="border-bottom:1px solid #ebebeb">
									<div class="box_view">
										<textarea class="content" onkeydown="resize(this)" onkeyup="resize(this)" style="width:99%; border:0px; font-size:15px; resize:none; overflow-x:hidden; max-height:300px;" placeholder="내용을 입력해주세요."></textarea>
									</div>
									<div class="modify">
